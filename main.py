...
if st.button("▶️ Run Selected App"):
    if app_choice == "Optimized Route (Shortest Path)":
        st.switch_page("pages/Optimized_Route.py")
    elif app_choice == "Excel Sequence (As Listed)":
        st.switch_page("pages/Excel_Sequence.py")
